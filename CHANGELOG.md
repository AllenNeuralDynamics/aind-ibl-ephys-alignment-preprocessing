...
- **deps**: require converter 0.5.0 from PyPI

## v0.5.0 (2026-09-15)

### Feat

- **ephys**: forward coherency block selection

## v0.4.5 (2026-08-26)

### Fix

- **ephys**: read the input recording from data_description schema 1 or 2

## v0.4.4 (2026-08-26)

### Fix

- **resolver**: accept asset names without the modality prefix

## v0.4.3 (2026-08-26)

### Fix

- decide the frame relatively, and never warp onto a header stub
- take the anatomical size from the caller, not the header stub

## v0.4.2 (2026-08-25)

### Fix

- give the domain tolerance headroom over its own bound

## v0.4.1 (2026-08-25)

### Fix

- honor a documented transform domain instead of always re-gridding
